...
export function Sidebar() {
	...
	return (
		...
		>
			<div className="flex h-full w-70 flex-col rounded-sm border border-zinc-700/90 bg-canvas py-3 text-zinc-300 shadow-[0_0_0_1px_rgba(0,0,0,0.5),0_16px_48px_rgba(0,0,0,0.45)]">
